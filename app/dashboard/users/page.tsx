    ...
    <div style={{ color: "var(--ink)" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {!loading && activeUsers.map(user => (
          <div key={user.id} style={{ background: "var(--d-surface)", border: "1px solid var(--d-border)", borderRadius: 16, padding: "16px 18px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {!loading && filteredRequests.map(request => (
          <div key={request.id} style={{ background: "var(--d-surface)", border: "1px solid var(--d-border)", borderRadius: 16, padding: "16px 18px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16, flexWrap: "wrap" }}>
              <div>
