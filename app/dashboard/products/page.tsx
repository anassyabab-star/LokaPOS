        ...
        <div className="rounded-lg border border-[color:var(--app-border)] bg-[color:var(--app-surface-soft)] p-3">
          ...
          <div className="space-y-2">
            <input
              ...
              className={`block w-full text-sm ${fieldClass}`}
            />
            <button
              type="button"
              onClick={() => void uploadNewProductImage()}
              disabled={!newImageFile || uploadingNewImage}
              className="w-full rounded bg-[#7F1D1D] px-4 py-2.5 text-sm text-[#ffffff] disabled:opacity-60"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-[color:var(--app-border)] pt-4">
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              />
              <button onClick={addInitialVariant} className="bg-[#7F1D1D] hover:bg-[#942424] px-3 py-2 rounded text-sm text-[#ffffff]">
                Add
              </button>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <input
                ...
                className={`w-20 ${fieldClass}`}
              />
              <button onClick={addInitialAddon} className="bg-[#7F1D1D] hover:bg-[#942424] px-3 py-2 rounded text-sm text-[#ffffff]">
                Add
              </button>
            </div>
          </div>
                  ...
                  <div>
                      ...
                      <div key={v.id} className="flex justify-between items-center mb-2 gap-2">
                        {editingVariantId === v.id ? (
                          <div className="flex flex-wrap gap-2 flex-1">
                            ...
                            />
                            <button onClick={() => void saveVariantEdit()} className="px-3 py-1 rounded text-sm bg-[#7F1D1D] hover:bg-[#942424] text-[#ffffff]">
                              Save
                            </button>
                            <button
                              onClick={() => {
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      ...
                      <input
                        ...
                        className={`w-20 ${fieldClass}`}
                      />
                      <button onClick={() => void addVariant(product.id)} className="bg-[#7F1D1D] hover:bg-[#942424] px-3 py-2 rounded text-sm text-[#ffffff]">
                        Add
                      </button>
                    </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div key={a.id} className="flex justify-between items-center mb-2 gap-2">
                        {editingAddonId === a.id ? (
                          <div className="flex flex-wrap gap-2 flex-1">
                            ...
                            />
                            <button onClick={() => void saveAddonEdit()} className="px-3 py-1 rounded text-sm bg-[#7F1D1D] hover:bg-[#942424] text-[#ffffff]">
                              Save
                            </button>
                            <button
                              onClick={() => {
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      ...
                      <input
                        ...
                        className={`w-20 ${fieldClass}`}
                      />
                      <button onClick={() => void addAddon(product.id)} className="bg-[#7F1D1D] hover:bg-[#942424] px-3 py-2 rounded text-sm text-[#ffffff]">
                        Add
                      </button>
                    </div>
                  </div>
